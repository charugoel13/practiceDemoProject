...
public class TestBase {
	...
	public TestBase(){
		try {
			prop = new Properties();
			FileInputStream ip = new FileInputStream("/Users/charu.goelmonotype.com/Desktop/prac_charu/practiceDemoProject/src/main/java/com/demo/qa/config/config.properties");
			prop.load(ip);
